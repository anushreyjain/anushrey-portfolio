...
const Experience = () => {
  ...
  return (
    ...
    >
      ...
      <div className="w-[90vw] sm:w-[70vw] h-full px-5 py-8 sm:px-20 sm:py-20 bg-zinc-900 sm:bg-zinc-950 shadow-lg shadow-black/[0.03] backdrop-blur-[0.5rem] bg-opacity-80 sm:bg-opacity-75 flex flex-col gap-20 sm:gap-36 mt-10 sm:mt-20 rounded-[10vw] sm:rounded-[5vw]">

...
const Contact = () => {
  ...
  return (
    <>
      <SectionWarpper
        routeLink={'mailto:anushrey1998@gmail.com'}
        title={"Let's talk"}
        lineColor={'#09090B'}
        ...
        >
          <div className="bg-opacity-20 -z-10 absolute -bottom-20 sm:right-[35rem] 
          h-[31.25rem] w-[50rem] rounded-full blur-[10rem] lg:w-[68.75rem] md:right-[-33rem] 
          lg:right-[-28rem] xl:right-[-20rem] 2xl:right:[-5rem] bg-[#636FA4]"></div>

          <div className="flex flex-col-reverse lg:flex-row items-center justify-center 
          gap-20 lg:gap-48 w-full lg:py-20 py-10 h-full">
            <div>
              ...
              >
                <input
                  className="h-14 rounded-lg px-4 text-zinc-200 bg-zinc-800 
                  bg-opacity-80 focus:bg-zinc-900 border border-transparent
                   focus:border-zinc-700 transition-all outline-none"
                  type="email"
                  name="senderEmail"
                ...
                />
                <textarea
                  className="h-52 my-3 rounded-lg p-4 text-zinc-200 bg-zinc-800
                   bg-opacity-80 focus:bg-zinc-900 border border-transparent
                    focus:border-zinc-700 transition-all outline-none"
                  name="senderMessage"
            ...
            <div className="">
              ...
              <SocialLinksContainer className="flex mt-5 w-full justify-center" />
            </div>
          </div>

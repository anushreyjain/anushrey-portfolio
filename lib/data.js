...
export const showcase = [
  ...
  {
    sNo: "04",
    title: "Trumigo(Apollo Tyres & BCG)",
...
export const experiencesData = [
  {
    company: "Massic AI",
    profile: "Lead Frontend Engineer",
    href: "https://www.massic.io/",
    duration: "2025-Present",
    tagline: ``,
    list: [
      `Led the frontend department, driving product direction, mentoring engineers, and establishing scalable delivery practices across projects.`,
      `Built agentic AI experiences focused on helping local businesses grow, translating business goals into intuitive, high-converting frontend workflows.`,
      `Implemented a company-wide global design system to unify branding, improve design consistency, and accelerate development across teams.`,
      `Enhanced performance, usability, and maintainability across the frontend stack using Next.js, Tailwind CSS, and reusable component architecture.`,
    ],
  },
  {
    company: "MVP Rockets",

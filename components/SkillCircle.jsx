...
const SkillCircle = ({
  ...
  return (
    ...
    >
      <div
        className="w-[4rem] h-[4rem] sm:w-[5rem] sm:h-[5rem] rounded-full border-[3px] border-zinc-900 relative flex justify-center items-center"
        style={{
          backgroundImage: `linear-gradient(${gradientAngles[index]}deg, var(--color-darkBlue), var(--color-zinc-950))`,
        }}
      >
        <div className="relative w-[1.5rem] h-[1.5rem] sm:w-[2rem] sm:h-[2rem] flex justify-center items-center">
